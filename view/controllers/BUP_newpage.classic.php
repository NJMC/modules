...
//echo "here is a new map page";
//if (jAuth::isConnected()))
//{
//$user = jAuth::getUserSession();
//echo "<br></br></br>
//echo "</br> You are connected.";//+ $user["firstname"] + " " + ["firstname"] ;
//var_dump(jAuth::getUserSession()));
//} else
//{
// echo "</br> You are not connected"
//}
