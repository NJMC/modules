...
{ifuserconnected}
	...
	<li class="dashboard-item"><a href="{jurl 'view~newpage:index'}">
			<span class="icon dashboard-icon"></span> <span class="text hidden-phone">{@view~default.header.menuitem.admin.label@}Methodology</span></a>
	</li>
    ...
    <li class="user dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="info-user">
            ...
            <span class="text hidden-phone">
                <span id="info-user-login" title="{$user->firstname} {$user->lastname}"> {$user->firstname} {$user->lastname} ({$user->login|eschtml})</span>
...
{else}
    <li class="dashboard-item"> <a href="/">
	<span class = "icon dashboard-icon"></span class = "text hidden-phone">Learn More</span></a>
	</li>
